...
<div id="modal" class="modal">
	<div class="modal-content">
		...
		<img
			src="https://i0.wp.com/image.slidesharecdn.com/informatica-150308210917-conversion-gate01/95/dibujo-tecnico-perspectiva-1-638.jpg?ssl=1"
			alt=""
			class="modal-image"
		/>
		<p><strong>Objetivo:</strong> Intenta recrear esta imagen sin ayuda de una guía</p>
	</div>
</div>
<main>
	<div class="container">
