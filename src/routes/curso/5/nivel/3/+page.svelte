<script lang="ts">
	...
	import { habitacion, line, eraser, } from '$lib/IMAGES/todas';
	...
	const setCanvasBackground = () => {
		...
		backgroundImage.src = habitacion;
...
<div id="modal" class="modal">
	<div class="modal-content">
		...
		<img src={habitacion} alt="" class="modal-image" />
		<p><strong>Objetivo:</strong> Intenta recrear esta imagen usando solo lineas.</p>
	</div>
</div>
<main>
	<div class="container">
